...
parser.add_argument("-use_multi_layers", dest="use_multi_layers", default=True, help="Use multi layers or not") 
...
parser.add_argument("-use_two_stage", dest="use_two_stage", default=True, help="Use two stage distill or not") 
...
parser.add_argument("-using_mask_weight", dest="using_mask_weight", default=True, help="Using mask weight or not")  
...
parser.add_argument("-using_test", dest="using_test", default=False, help="test mode") 
parser.add_argument("-first_training", dest="first_training", default=True, help="First training on a dataset") 
parser.add_argument("-without_hier_distill", dest="without_hier_distill", default=False, help="Without hier distillation") 
parser.add_argument("-without_two_stage", dest="without_two_stage", default=False, help="Without two stage") 
parser.add_argument("-without_multi_layers", dest="without_multi_layers", default=False, help="Without multi layers") 
...
parser.add_argument("-alignment_weight", dest="alignment_weight", type=float, default=0.0, help="The weight of knowledge alignment loss, 0 means disabled")
parser.add_argument("-lambda_align", dest="lambda_align", type=float, default=0.5, help="Balance between semantic(WD) and topological(GWD) alignment, 0.5 means balanced")
